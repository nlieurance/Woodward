...
### Milestones
As I work on the above priorities, I’ll make progress towards several artifacts and insights:
- User personas to understand user needs at a glance
- Journey maps with jobs-to-be-done, pain points, and opportunities
- Process map that shows how Woodward goes from design to finished part, who is involved during each step, and what the handoff from the technical writer to the shop floor looks like 

### Reporting
I’ll report on progress toward each milestone on a weekly basis.
